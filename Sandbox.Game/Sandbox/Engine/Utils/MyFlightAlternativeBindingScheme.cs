...
// Type: Sandbox.Engine.Utils.MyFlightAlternativeBindingScheme
...
namespace Sandbox.Engine.Utils
{
  internal class MyFlightAlternativeBindingScheme : IMyControlsBindingScheme
  {
    public void CreateBinding(bool invertYAxisCharacter, bool invertYAxisJetpackVehicle)
    {
      ...
      MyFlightAlternativeBindingScheme.CreateForSpectator(invertYAxisCharacter, invertYAxisJetpackVehicle);
    }
    ...
    private void CreateForBase()
    {
      ...
      MyControllerHelper.AddControl(cxBase, MyControlsSpace.LOOKAROUND, MyJoystickButtonsEnum.J05, MyJoystickButtonsEnum.J06, false);
      MyControllerHelper.AddControl(cxBase, MyControlsSpace.CAMERA_ZOOM_IN, MyJoystickButtonsEnum.J06, MyJoystickAxesEnum.Yneg, true);
      MyControllerHelper.AddControl(cxBase, MyControlsSpace.CAMERA_ZOOM_OUT, MyJoystickButtonsEnum.J06, MyJoystickAxesEnum.Ypos, true);
      ...
      MyControllerHelper.AddControl(cxBase, MyControlsSpace.FAKE_CAMERA_ZOOM, "\xE006+\xE025".ToString());
    ...
    private void CreateForCharacter(bool invertYAxisCharacter, bool invertYAxisJetpackVehicle)
    {
      ...
      MyControllerHelper.AddControl(cxCharacter, MyControlsSpace.STRAFE_LEFT, MyJoystickAxesEnum.Xneg);
      MyControllerHelper.AddControl(cxCharacter, MyControlsSpace.STRAFE_RIGHT, MyJoystickAxesEnum.Xpos);
      ...
      MyControllerHelper.AddControl(cxCharacter, MyControlsSpace.FAKE_RB_LS_H, "\xE006+\xE022".ToString());
    ...
    private void CreateForJetpack(bool invertYAxisCharacter, bool invertYAxisJetpackVehicle)
    {
      ...
      MyFlightAlternativeBindingScheme.CreateCommonForJetpackAndShip(cxJetpack, invertYAxisCharacter, invertYAxisJetpackVehicle);
    }
    ...
    private void CreateForSpaceship(bool invertYAxisCharacter, bool invertYAxisJetpackVehicle)
    {
      ...
      MyFlightAlternativeBindingScheme.CreateCommonForJetpackAndShip(cxSpaceship, invertYAxisCharacter, invertYAxisJetpackVehicle);
      ...
      MyControllerHelper.AddControl(cxSpaceship, MyControlsSpace.FAKE_MOVEMENT_H, "\xE005+\xE009");
      MyControllerHelper.AddControl(cxSpaceship, MyControlsSpace.FAKE_MOVEMENT_V, "\xE005+\xE025");
    }

    private static void CreateCommonForJetpackAndShip(
      MyStringId context,
      bool invertYAxisCharacter,
      bool invertYAxisJetpackVehicle)
    {
      MyControllerHelper.AddControl(context, MyControlsSpace.ROTATION_LEFT, MyJoystickButtonsEnum.J05, MyJoystickAxesEnum.Xneg, false);
      MyControllerHelper.AddControl(context, MyControlsSpace.ROTATION_RIGHT, MyJoystickButtonsEnum.J05, MyJoystickAxesEnum.Xpos, false);
      MyControllerHelper.AddControl(context, MyControlsSpace.STRAFE_LEFT, MyJoystickButtonsEnum.J05, MyJoystickAxesEnum.Xneg, true);
      MyControllerHelper.AddControl(context, MyControlsSpace.STRAFE_RIGHT, MyJoystickButtonsEnum.J05, MyJoystickAxesEnum.Xpos, true);
      if (invertYAxisJetpackVehicle)
      {
        MyControllerHelper.AddControl(context, MyControlsSpace.ROTATION_DOWN, MyJoystickButtonsEnum.J05, MyJoystickButtonsEnum.J06, MyJoystickAxesEnum.RotationYneg, false);
        MyControllerHelper.AddControl(context, MyControlsSpace.ROTATION_UP, MyJoystickButtonsEnum.J05, MyJoystickButtonsEnum.J06, MyJoystickAxesEnum.RotationYpos, false);
      ...
      {
        MyControllerHelper.AddControl(context, MyControlsSpace.ROTATION_UP, MyJoystickButtonsEnum.J05, MyJoystickButtonsEnum.J06, MyJoystickAxesEnum.RotationYneg, false);
        MyControllerHelper.AddControl(context, MyControlsSpace.ROTATION_DOWN, MyJoystickButtonsEnum.J05, MyJoystickButtonsEnum.J06, MyJoystickAxesEnum.RotationYpos, false);
      ...
      MyControllerHelper.AddControl(context, MyControlsSpace.ROLL_LEFT, MyJoystickButtonsEnum.J06, MyJoystickAxesEnum.RotationXneg, false);
      MyControllerHelper.AddControl(context, MyControlsSpace.ROLL_RIGHT, MyJoystickButtonsEnum.J06, MyJoystickAxesEnum.RotationXpos, false);
      MyControllerHelper.AddControl(context, MyControlsSpace.LOOK_LEFT, MyJoystickButtonsEnum.J06, MyJoystickAxesEnum.RotationXneg, true);
      MyControllerHelper.AddControl(context, MyControlsSpace.LOOK_RIGHT, MyJoystickButtonsEnum.J06, MyJoystickAxesEnum.RotationXpos, true);
    }
      ...
      bool invertYAxisJetpackVehicle)
    {
      ...
      MyControllerHelper.AddControl(cxSpectator, MyControlsSpace.FAKE_RB_V, "\xE006+" + '\xE00A'.ToString());
      MyControllerHelper.AddControl(cxSpectator, MyControlsSpace.FAKE_RB_H, "\xE006+" + '\xE00A'.ToString());
