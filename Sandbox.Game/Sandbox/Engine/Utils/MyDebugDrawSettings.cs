...
// Type: Sandbox.Engine.Utils.MyDebugDrawSettings
...
namespace Sandbox.Engine.Utils
{
  public static class MyDebugDrawSettings
  {
    ...
    public static float DEBUG_DRAW_MODEL_DUMMIES_DISTANCE = 0.0f;
    ...
    public static bool ENABLE_DEBUG_DRAW
    {
      set
      {
        MyDebugDrawSettings.m_enableDebugDraw = value;
        if (MyDebugDrawSettings.m_enableDebugDraw)
          return;
        MyRenderProxy.DebugClearPersistentMessages();
      }
      get => MyDebugDrawSettings.m_enableDebugDraw;
    }

    public static Color GetColor(int i) => MyDebugDrawSettings.DEBUG_COLORS[i % MyDebugDrawSettings.DEBUG_COLORS.Length];
  }
}
