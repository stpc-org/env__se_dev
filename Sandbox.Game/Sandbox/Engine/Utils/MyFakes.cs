...
// Type: Sandbox.Engine.Utils.MyFakes
...
namespace Sandbox.Engine.Utils
{
  ...
  {
    public static MyQuickLaunchType? QUICK_LAUNCH = new MyQuickLaunchType?();
    public static bool ALT_AS_DEBUG_KEY = true;
    public static bool ENABLE_F12_MENU = false;
    ...
    internal static MyEntity FakeTarget = (MyEntity) null;
    ...
    public static float DEFORMATION_VOXEL_CUTOUT_MULTIPLIER_SMALL_GRID = 2.6f;
    ...
    public static bool ENABLE_GRID_SYSTEM_ONCE_BEFORE_FRAME_UPDATE = MyFakes.ENABLE_GRID_SYSTEM_UPDATE;
    ...
    public static MyEntity VDB_ENTITY = (MyEntity) null;
    ...
    public static int VOICE_CHAT_TARGET_BIT_RATE = 0;
    public static float VOICE_CHAT_MIC_SENSITIVITY = 0.5f;
    public static bool VOICE_CHAT_ECHO = false;
    public static float VOICE_CHAT_PLAYBACK_DELAY = 500f;
    ...
    public static bool USE_GOODBOT_DEV_SERVER = MyPlatformGameSettings.PUBLIC_BETA_MP_TEST;
    ...
    public static bool COLLECT_SUSPEND_DUMPS = false;
    ...
    public static bool OWN_ALL_DLCS = false;
    public static bool OWN_ALL_ITEMS = false;
    public static readonly uint SWITCH_DLC_FROM = 0;
    public static readonly uint SWITCH_DLC_TO = 0;
    public static bool FORCE_ADD_TRASH_REMOVAL_MENU = false;
    public static bool ENABLE_GDPR_MESSAGE = true;
    public static bool ENABLE_ASTEROIDS = true;
    public static bool ENABLE_GRID_STORAGE_TEST_FUNCTIONS = false;
    public static readonly bool ENABLE_STATION_GENERATOR_DEBUG_DRAW = false;
    public static readonly bool ENABLE_RELATION_GENERATOR_DEBUG_DRAW = false;
    public static readonly bool ENABLE_ZONE_CHIP_REQ = true;
    public static readonly bool CONTRACT_ESCORT_DEBUGDRAW = false;
    public static readonly bool CONV_PULL_CACL_IMMIDIATLY_STORE_SAFEZONE = true;
    public static bool ENABLE_AREA_INTERACTIONS = true;
    public static bool ENABLE_AREA_INTERACTIONS_BLOCKS = false;
    public static bool NETWORK_SINGLE_THREADED = false;
    public static bool ENABLE_SMART_UPDATER = true;
    public static bool ENABLE_ECONOMY_ANALYTICS = false;
    public static readonly bool ENABLE_BOULDER_NAME_PARSING = false;
    public static readonly bool ENABLE_DOOR_SAFETY = true;
    public static readonly bool ENABLE_DOOR_SAFETY_2 = false;
    public static bool USE_PARALLEL_TOOL_RAYCAST = false;
    public static readonly bool ENABLE_MAGBOOTS_ON_GRID_SMOOTHING = true;
    public static bool ENABLE_PERFORMANCELOGGING = false;
    public static bool ForcePlayoutDelayBuffer = false;
    public static bool ENABLE_CHARACTER_IK_FEET_OFFSET = true;
    public static float CHARACTER_ANIMATION_SPEED = 1f;
    public static float CHARACTER_ANKLE_HEIGHT = 0.187f;
    public static bool CHARACTER_FOOTS_DEBUG_DRAW = false;
    public static bool RECORD_CHARACTER_FOOT_ANIMATION = false;
    public static bool HIDE_CROSSHAIR_OPTIONS = true;
    public static readonly bool SHOW_MATCH_STOP = false;
    public static readonly bool ENABLE_DYNAMIC_EFFECTIVE_RANGE = true;

    static MyFakes() => RuntimeHelpers.RunClassConstructor(typeof (MyFakesLocal).TypeHandle);
  }
}
