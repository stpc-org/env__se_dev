...
// Type: Sandbox.Game.Gui.MyGuiScreenDialogViewEdge
...
namespace Sandbox.Game.Gui
{
  internal class MyGuiScreenDialogViewEdge : MyGuiScreenBase
  {
    ...
    public override string GetFriendlyName() => nameof (MyGuiScreenDialogViewEdge);

    public override void RecreateControls(bool contructor)
    {
      base.RecreateControls(contructor);
      this.Controls.Add((MyGuiControlBase) new MyGuiControlLabel(new Vector2?(new Vector2(0.0f, -0.1f)), text: "Enter the number of winged-edge mesh edge to view", originAlign: MyGuiDrawAlignEnum.HORISONTAL_CENTER_AND_VERTICAL_CENTER));
