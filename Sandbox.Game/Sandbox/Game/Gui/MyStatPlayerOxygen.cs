...
// Type: Sandbox.Game.GUI.MyStatPlayerOxygen
...
namespace Sandbox.Game.GUI
{
  ...
  {
    public MyStatPlayerOxygen() => this.Id = MyStringHash.GetOrCompute("player_oxygen");
    ...
    public override void Update()
    {
      ...
      if (localCharacter == null || localCharacter.OxygenComponent == null)
        return;
      this.CurrentValue = localCharacter.OxygenComponent.SuitOxygenLevel;
    }
