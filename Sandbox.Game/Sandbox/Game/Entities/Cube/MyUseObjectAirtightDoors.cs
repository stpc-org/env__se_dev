...
// Type: Sandbox.Game.Entities.Cube.MyUseObjectAirtightDoors
...
namespace Sandbox.Game.Entities.Cube
{
  ...
  public class MyUseObjectAirtightDoors : MyUseObjectBase
  {
    ...
    public MyUseObjectAirtightDoors(
      IMyEntity owner,
      string dummyName,
    ...
    public override void Use(UseActionEnum actionEnum, IMyEntity entity)
    {
      ...
      MyRelationsBetweenPlayerAndBlock userRelationToOwner = this.Door.GetUserRelationToOwner(controllingIdentityId);
      switch (actionEnum)
      {
