...
// Type: Sandbox.Game.Screens.Helpers.RadialMenuActions.MyActionToggleSymmetry
...
namespace Sandbox.Game.Screens.Helpers.RadialMenuActions
{
  public class MyActionToggleSymmetry : MyActionBase
  {
    ...
    public override MyRadialLabelText GetLabel(string shortcut, string name)
    {
      ...
      label.State = !MyCubeBuilder.Static.UseSymmetry ? MyTexts.GetString(MySpaceTexts.RadialMenuAction_Symmetry_Off) : MyTexts.GetString(MySpaceTexts.RadialMenuAction_Symmetry_On);
      if (!MySession.Static.CreativeToolsEnabled(Sync.MyId) && !MySession.Static.CreativeMode)
