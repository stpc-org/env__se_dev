...
// Type: Sandbox.Game.Screens.Models.MyContractConditionDeliverPackageModel
...
namespace Sandbox.Game.Screens.Models
{
  ...
  public class MyContractConditionDeliverPackageModel : MyContractConditionModel
  {
    ...
    {
      base.Init(ob);
      MyObjectBuilder_ContractConditionDeliverPackage conditionDeliverPackage = ob as MyObjectBuilder_ContractConditionDeliverPackage;
    }
