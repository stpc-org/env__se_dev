...
// Type: Sandbox.Game.SessionComponents.MyBrushBox
...
namespace Sandbox.Game.SessionComponents
{
  public class MyBrushBox : IMyVoxelBrush
  {
    ...
    {
      Vector3D vector3D = new Vector3D((double) this.m_width.Value, (double) this.m_height.Value, (double) this.m_depth.Value) * 0.5;
      this.m_shape.Boundaries.Min = -vector3D;
      this.m_shape.Boundaries.Max = vector3D;
    }
