...
namespace VRageMath
{
  ...
  public class Curve
  {
    ...
    public void ComputeTangent(int keyIndex, CurveTangent tangentType) => this.ComputeTangent(keyIndex, tangentType, tangentType);
      ...
      CurveTangent tangentOutType)
    {
      ...
      if (tangentInType == CurveTangent.Smooth)
      {
        ...
        key.TangentIn = tangentInType != CurveTangent.Linear ? 0.0f : num6 - num7;
    ...
    public void ComputeTangents(CurveTangent tangentType) => this.ComputeTangents(tangentType, tangentType);
    ...
    private static float Hermite(CurveKey k0, CurveKey k1, float t)
    {
      ...
      return (float) (internalValue1 * (2.0 * (double) num2 - 3.0 * (double) num1 + 1.0) + (double) internalValue2 * (-2.0 * (double) num2 + 3.0 * (double) num1) + (double) tangentOut * ((double) num2 - 2.0 * (double) num1 + (double) t) + (double) tangentIn * ((double) num2 - (double) num1));
    }

    protected class VRageMath_Curve\u003C\u003Ekeys\u003C\u003EAccessor : IMemberAccessor<Curve, CurveKeyCollection>
    {
      [MethodImpl(MethodImplOptions.AggressiveInlining)]
      public virtual void Set(ref Curve owner, in CurveKeyCollection value) => owner.keys = value;

      [MethodImpl(MethodImplOptions.AggressiveInlining)]
      public virtual void Get(ref Curve owner, out CurveKeyCollection value) => value = owner.keys;
    }

    protected class VRageMath_Curve\u003C\u003EpreLoop\u003C\u003EAccessor : IMemberAccessor<Curve, CurveLoopType>
    {
      [MethodImpl(MethodImplOptions.AggressiveInlining)]
      public virtual void Set(ref Curve owner, in CurveLoopType value) => owner.preLoop = value;

      [MethodImpl(MethodImplOptions.AggressiveInlining)]
      public virtual void Get(ref Curve owner, out CurveLoopType value) => value = owner.preLoop;
    }

    protected class VRageMath_Curve\u003C\u003EpostLoop\u003C\u003EAccessor : IMemberAccessor<Curve, CurveLoopType>
    {
      [MethodImpl(MethodImplOptions.AggressiveInlining)]
      public virtual void Set(ref Curve owner, in CurveLoopType value) => owner.postLoop = value;

      [MethodImpl(MethodImplOptions.AggressiveInlining)]
      public virtual void Get(ref Curve owner, out CurveLoopType value) => value = owner.postLoop;
    }
