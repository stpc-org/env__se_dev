...
namespace VRageMath
{
  ...
  internal class Gjk
  {
    ...
    protected class VRageMath_Gjk\u003C\u003EclosestPoint\u003C\u003EAccessor : IMemberAccessor<Gjk, Vector3>
    {
      [MethodImpl(MethodImplOptions.AggressiveInlining)]
      public virtual void Set(ref Gjk owner, in Vector3 value) => owner.closestPoint = value;

      [MethodImpl(MethodImplOptions.AggressiveInlining)]
      public virtual void Get(ref Gjk owner, out Vector3 value) => value = owner.closestPoint;
    }

    protected class VRageMath_Gjk\u003C\u003Ey\u003C\u003EAccessor : IMemberAccessor<Gjk, Vector3[]>
    {
      [MethodImpl(MethodImplOptions.AggressiveInlining)]
      public virtual void Set(ref Gjk owner, in Vector3[] value) => owner.y = value;

      [MethodImpl(MethodImplOptions.AggressiveInlining)]
      public virtual void Get(ref Gjk owner, out Vector3[] value) => value = owner.y;
    }

    protected class VRageMath_Gjk\u003C\u003EyLengthSq\u003C\u003EAccessor : IMemberAccessor<Gjk, float[]>
    {
      [MethodImpl(MethodImplOptions.AggressiveInlining)]
      public virtual void Set(ref Gjk owner, in float[] value) => owner.yLengthSq = value;

      [MethodImpl(MethodImplOptions.AggressiveInlining)]
      public virtual void Get(ref Gjk owner, out float[] value) => value = owner.yLengthSq;
    }

    protected class VRageMath_Gjk\u003C\u003Eedges\u003C\u003EAccessor : IMemberAccessor<Gjk, Vector3[][]>
    {
      [MethodImpl(MethodImplOptions.AggressiveInlining)]
      public virtual void Set(ref Gjk owner, in Vector3[][] value) => owner.edges = value;

      [MethodImpl(MethodImplOptions.AggressiveInlining)]
      public virtual void Get(ref Gjk owner, out Vector3[][] value) => value = owner.edges;
    }

    protected class VRageMath_Gjk\u003C\u003EedgeLengthSq\u003C\u003EAccessor : IMemberAccessor<Gjk, float[][]>
    {
      [MethodImpl(MethodImplOptions.AggressiveInlining)]
      public virtual void Set(ref Gjk owner, in float[][] value) => owner.edgeLengthSq = value;

      [MethodImpl(MethodImplOptions.AggressiveInlining)]
      public virtual void Get(ref Gjk owner, out float[][] value) => value = owner.edgeLengthSq;
    }

    protected class VRageMath_Gjk\u003C\u003Edet\u003C\u003EAccessor : IMemberAccessor<Gjk, float[][]>
    {
      [MethodImpl(MethodImplOptions.AggressiveInlining)]
      public virtual void Set(ref Gjk owner, in float[][] value) => owner.det = value;

      [MethodImpl(MethodImplOptions.AggressiveInlining)]
      public virtual void Get(ref Gjk owner, out float[][] value) => value = owner.det;
    }

    protected class VRageMath_Gjk\u003C\u003EsimplexBits\u003C\u003EAccessor : IMemberAccessor<Gjk, int>
    {
      [MethodImpl(MethodImplOptions.AggressiveInlining)]
      public virtual void Set(ref Gjk owner, in int value) => owner.simplexBits = value;

      [MethodImpl(MethodImplOptions.AggressiveInlining)]
      public virtual void Get(ref Gjk owner, out int value) => value = owner.simplexBits;
    }

    protected class VRageMath_Gjk\u003C\u003EmaxLengthSq\u003C\u003EAccessor : IMemberAccessor<Gjk, float>
    {
      [MethodImpl(MethodImplOptions.AggressiveInlining)]
      public virtual void Set(ref Gjk owner, in float value) => owner.maxLengthSq = value;

      [MethodImpl(MethodImplOptions.AggressiveInlining)]
      public virtual void Get(ref Gjk owner, out float value) => value = owner.maxLengthSq;
    }
  }
}
