...
namespace VRage.ModAPI
{
  public interface IMyEntities
  {
    ...
    void RemapObjectBuilderCollection(
    ...
    void EnableEntityBoundingBoxDraw(
      IMyEntity entity,
      bool enable,
      Vector4? color = null,
    ...
    List<IMyEntity> GetIntersectionWithSphere(
      ref BoundingSphereD sphere,
      IMyEntity ignoreEntity0,
      IMyEntity ignoreEntity1,
      bool ignoreVoxelMaps,
