...
// Type: VRage.Game.MySunWindConstants
...
namespace VRage.Game
{
  public static class MySunWindConstants
  {
    ...
    public static readonly Vector2I LARGE_BILLBOARDS_SIZE_HALF = new Vector2I(MySunWindConstants.LARGE_BILLBOARDS_SIZE.X / 2, MySunWindConstants.LARGE_BILLBOARDS_SIZE.Y / 2);
    ...
    public static readonly Vector2I SMALL_BILLBOARDS_SIZE_HALF = new Vector2I(MySunWindConstants.SMALL_BILLBOARDS_SIZE.X / 2, MySunWindConstants.SMALL_BILLBOARDS_SIZE.Y / 2);
