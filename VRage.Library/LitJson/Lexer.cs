...
namespace LitJson
{
  internal class Lexer
  {
    ...
    static Lexer() => Lexer.PopulateFsmTables(out Lexer.fsm_handler_table, out Lexer.fsm_return_table);
    ...
    private static void PopulateFsmTables(
      out Lexer.StateHandler[] fsm_handler_table,
      out int[] fsm_return_table)
    {
      fsm_handler_table = new Lexer.StateHandler[28]
      {
