...
// Type: VRage.Library.Collections.MyMultiKeyIndex`3
...
namespace VRage.Library.Collections
{
  public class MyMultiKeyIndex<TKey1, TKey2, TValue> : IEnumerable<TValue>, IEnumerable
  {
    ...
    {
      TValue obj;
      return this.m_index1.TryGetValue(key1, out obj) && this.m_index2.Remove(this.KeySelector2(obj)) && this.m_index1.Remove(key1);
    }

    public bool Remove(TKey2 key2)
    {
      TValue obj;
      return this.m_index2.TryGetValue(key2, out obj) && this.m_index1.Remove(this.KeySelector1(obj)) && this.m_index2.Remove(key2);
    }

    public bool Remove(TKey1 key1, TKey2 key2) => this.m_index1.Remove(key1) && this.m_index2.Remove(key2);

    public bool TryRemove(TKey1 key1, out TValue removedValue) => this.m_index1.TryGetValue(key1, out removedValue) && this.m_index2.Remove(this.KeySelector2(removedValue)) && this.m_index1.Remove(key1);

    public bool TryRemove(TKey2 key2, out TValue removedValue) => this.m_index2.TryGetValue(key2, out removedValue) && this.m_index1.Remove(this.KeySelector1(removedValue)) && this.m_index2.Remove(key2);
