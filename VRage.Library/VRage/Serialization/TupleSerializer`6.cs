...
// Type: VRage.Serialization.TupleSerializer`6
...
namespace VRage.Serialization
{
  public class TupleSerializer<T1, T2, T3, T4, T5, T6> : ISerializer<MyTuple<T1, T2, T3, T4, T5, T6>>
  {
    ...
    void ISerializer<MyTuple<T1, T2, T3, T4, T5, T6>>.Serialize(
      ByteStream destination,
      ref MyTuple<T1, T2, T3, T4, T5, T6> data)
    {
    ...
    void ISerializer<MyTuple<T1, T2, T3, T4, T5, T6>>.Deserialize(
      ByteStream source,
      out MyTuple<T1, T2, T3, T4, T5, T6> data)
    {
