...
// Type: EmptyKeys.UserInterface.Generated.ActiveContractsView
...
namespace EmptyKeys.UserInterface.Generated
{
  ...
  public class ActiveContractsView : UIRoot
  {
    ...
    public ActiveContractsView() => this.Initialize();
    ...
    private void InitializeComponent()
    {
      ...
      ActiveContractsView.InitializeElementResources((UIElement) this);
      ...
      ActiveContractsView.InitializeElemente_7Resources((UIElement) this.e_7);
      this.e_8 = new Grid();
      ...
      this.e_12.Name = "e_12";
      this.e_12.Height = 2f;
      this.e_12.Margin = new Thickness(0.0f, 10f, 0.0f, 10f);
      ...
      this.e_13 = new Grid();
      this.e_6.Children.Add((UIElement) this.e_13);
      this.e_13.Name = "e_13";
      this.e_13.Margin = new Thickness(0.0f, 0.0f, 0.0f, 30f);
      this.e_13.ColumnDefinitions.Add(new ColumnDefinition());
      this.e_13.ColumnDefinitions.Add(new ColumnDefinition()
      {
      ...
      Grid.SetRow((UIElement) this.e_13, 2);
      Grid.SetColumnSpan((UIElement) this.e_13, 2);
      this.e_14 = new Button();
      this.e_13.Children.Add((UIElement) this.e_14);
      this.e_14.Name = "e_14";
      this.e_14.Margin = new Thickness(10f, 10f, 0.0f, 10f);
      this.e_14.VerticalAlignment = VerticalAlignment.Center;
      this.e_14.TabIndex = 1;
      Grid.SetColumn((UIElement) this.e_14, 1);
      this.e_14.SetBinding(Button.CommandProperty, new Binding("RefreshActiveCommand")
      {
        UseGeneratedBindings = true
      });
      this.e_14.SetResourceReference(ContentControl.ContentProperty, (object) "ContractScreen_Button_Refresh");
      this.e_15 = new Button();
      this.e_13.Children.Add((UIElement) this.e_15);
      this.e_15.Name = "e_15";
      this.e_15.Margin = new Thickness(10f, 10f, 0.0f, 10f);
      this.e_15.VerticalAlignment = VerticalAlignment.Center;
      this.e_15.TabIndex = 2;
      Grid.SetColumn((UIElement) this.e_15, 2);
      this.e_15.SetBinding(UIElement.IsEnabledProperty, new Binding("IsAbandonEnabled")
      {
        UseGeneratedBindings = true
      });
      this.e_15.SetBinding(Button.CommandProperty, new Binding("AbandonCommand")
      {
        UseGeneratedBindings = true
      });
      this.e_15.SetResourceReference(ContentControl.ContentProperty, (object) "ContractScreen_Button_Abandon");
