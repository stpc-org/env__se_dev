...
// Type: EmptyKeys.UserInterface.Generated.AtmBlockView
...
namespace EmptyKeys.UserInterface.Generated
{
  ...
  public class AtmBlockView : UIRoot
  {
    ...
    public AtmBlockView() => this.Initialize();
    ...
    private void InitializeComponent()
    {
      ...
      AtmBlockView.InitializeElementResources((UIElement) this);
      ...
      this.e_7.SetBinding(UIElement.DataContextProperty, new Binding("InventoryTargetViewModel")
      {
        UseGeneratedBindings = true
      });
      this.e_8 = new Grid();
      ...
      ControlTemplate controlTemplate = new ControlTemplate(typeof (ListBox), new Func<UIElement, UIElement>(AtmBlockView.e_9_s_S_1_ctMethod));
      ...
      AtmBlockView.InitializeElemente_9Resources((UIElement) this.e_9);
      this.e_14 = new Grid();
      ...
      this.e_26.Name = "e_26";
      this.e_26.Height = 20f;
      this.e_26.Margin = new Thickness(4f, 2f, 2f, 2f);
      this.e_26.VerticalAlignment = VerticalAlignment.Center;
      this.e_26.Stretch = Stretch.Uniform;
      Grid.SetColumn((UIElement) this.e_26, 2);
      Grid.SetRow((UIElement) this.e_26, 1);
      this.e_26.SetBinding(Image.SourceProperty, new Binding("CurrencyIcon")
      {
        UseGeneratedBindings = true
      });
      ...
      this.e_27.Background = (Brush) new SolidColorBrush(new ColorW(77, 99, 113, (int) byte.MaxValue));
      Grid.SetRow((UIElement) this.e_27, 2);
      Grid.SetColumnSpan((UIElement) this.e_27, 3);
      this.e_28 = new Grid();
      this.e_20.Children.Add((UIElement) this.e_28);
      this.e_28.Name = "e_28";
      this.e_28.Margin = new Thickness(0.0f, 0.0f, 0.0f, 30f);
      ...
      this.e_29.Name = "e_29";
      this.e_29.Margin = new Thickness(0.0f, 5f, 5f, 5f);
      this.e_29.VerticalAlignment = VerticalAlignment.Center;
      this.e_29.TabIndex = 2;
      this.e_29.SetBinding(Button.CommandProperty, new Binding("DepositCommand")
      {
        UseGeneratedBindings = true
      });
      this.e_29.SetResourceReference(ContentControl.ContentProperty, (object) "FactionTerminal_Deposit_Currency");
      ...
      this.e_30.TabIndex = 3;
      Grid.SetColumn((UIElement) this.e_30, 1);
      this.e_30.SetBinding(Button.CommandProperty, new Binding("WithdrawCommand")
      {
        UseGeneratedBindings = true
      });
      this.e_30.SetResourceReference(ContentControl.ContentProperty, (object) "FactionTerminal_Withdraw_Currency");
    ...
    private static void InitializeElemente_9Resources(UIElement elem)
    {
      ...
      style.Setters.Add(setter1);
      ControlTemplate controlTemplate = new ControlTemplate(typeof (ListBoxItem), new Func<UIElement, UIElement>(AtmBlockView.e_9r_0_s_S_1_ctMethod));
