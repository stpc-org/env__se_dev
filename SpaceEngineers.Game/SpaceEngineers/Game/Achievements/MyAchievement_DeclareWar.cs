...
// Type: SpaceEngineers.Game.Achievements.MyAchievement_DeclareWar
...
namespace SpaceEngineers.Game.Achievements
{
  ...
  {
    protected override (string, string, float) GetAchievementInfo() => ("MyAchievment_DeclareWar", (string) null, 0.0f);
      ...
      long senderId)
    {
      ...
      if (playerFaction == null || !(MySession.Static.Factions.TryGetFactionById(toFactionId) is MyFaction factionById) || factionById.FactionType != MyFactionTypes.PlayerMade || (!playerFaction.IsFounder(identityId) && !playerFaction.IsLeader(identityId) || (playerFaction.FactionId != fromFactionId || action != MyFactionStateChange.DeclareWar)))
        return;
      this.NotifyAchieved();
      MySession.Static.Factions.FactionStateChanged -= new Action<MyFactionStateChange, long, long, long, long>(this.Factions_FactionStateChanged);
    }
