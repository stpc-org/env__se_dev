...
// Type: SpaceEngineers.Game.Entities.UseObjects.VendingMachine.MyUseObjectJukeboxPause
...
namespace SpaceEngineers.Game.Entities.UseObjects.VendingMachine
{
  ...
  public class MyUseObjectJukeboxPause : MyUseObjectBase
  {
    ...
    public MyUseObjectJukeboxPause(
      IMyEntity owner,
      string dummyName,
    ...
    public override MyActionDescription GetActionInfo(UseActionEnum actionEnum)
    {
      ...
      return new MyActionDescription()
      {
        Text = MySpaceTexts.NotificationHintJukeboxPlay,
