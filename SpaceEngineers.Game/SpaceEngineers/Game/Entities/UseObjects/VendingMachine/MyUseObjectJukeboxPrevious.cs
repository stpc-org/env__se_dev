...
// Type: SpaceEngineers.Game.Entities.UseObjects.VendingMachine.MyUseObjectJukeboxPrevious
...
namespace SpaceEngineers.Game.Entities.UseObjects.VendingMachine
{
  ...
  public class MyUseObjectJukeboxPrevious : MyUseObjectBase
  {
    ...
    public MyUseObjectJukeboxPrevious(
      IMyEntity owner,
      string dummyName,
    ...
    public override MyActionDescription GetActionInfo(UseActionEnum actionEnum)
    {
      ...
      return new MyActionDescription()
      {
        Text = MySpaceTexts.NotificationHintJukeboxPlayPrevious,
