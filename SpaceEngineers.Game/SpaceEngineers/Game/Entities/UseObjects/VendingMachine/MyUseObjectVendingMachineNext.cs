...
// Type: SpaceEngineers.Game.Entities.UseObjects.VendingMachine.MyUseObjectVendingMachineNext
...
namespace SpaceEngineers.Game.Entities.UseObjects.VendingMachine
{
  ...
  public class MyUseObjectVendingMachineNext : MyUseObjectBase
  {
    ...
    public MyUseObjectVendingMachineNext(
      IMyEntity owner,
      string dummyName,
    ...
    public override MyActionDescription GetActionInfo(UseActionEnum actionEnum)
    {
      ...
      switch (actionEnum)
      {
        case UseActionEnum.Manipulate:
          ...
          {
            Text = MySpaceTexts.NotificationHintNextItem,
