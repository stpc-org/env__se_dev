...
// Type: SpaceEngineers.Game.Entities.UseObjects.VendingMachine.MyUseObjectVendingMachineBuy
...
namespace SpaceEngineers.Game.Entities.UseObjects.VendingMachine
{
  ...
  public class MyUseObjectVendingMachineBuy : MyUseObjectBase
  {
    ...
    public MyUseObjectVendingMachineBuy(
      IMyEntity owner,
      string dummyName,
    ...
    public override MyActionDescription GetActionInfo(UseActionEnum actionEnum)
    {
      ...
      switch (actionEnum)
      {
        case UseActionEnum.Manipulate:
          ...
          {
            Text = MySpaceTexts.NotificationHintBuyItem,
