...
// Type: SpaceEngineers.Game.Entities.UseObjects.MyUseObjectAtmBlock
...
namespace SpaceEngineers.Game.Entities.UseObjects
{
  ...
  public class MyUseObjectAtmBlock : MyUseObjectBase
  {
    ...
    public override MyActionDescription GetActionInfo(UseActionEnum actionEnum)
    {
      ...
      return new MyActionDescription()
      {
        Text = MySpaceTexts.NotificationHintPressToAccessAtm,
    ...
    public override void Use(UseActionEnum actionEnum, IMyEntity userEntity)
    {
      ...
      switch (actionEnum)
      {
        case UseActionEnum.Manipulate:
          ...
          MyGuiScreenAtmBlock screen = MyGuiSandbox.CreateScreen<MyGuiScreenAtmBlock>((object) new MyStoreBlockViewModel(owner));
